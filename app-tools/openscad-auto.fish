...
set OPENSCAD_OUTPUT (openscad -o $SOURCE_FILE.stl $SOURCE_FILE 2>&1 | tee /dev/stderr)
...
terminal-notifier -title "openscad-auto" -message "Done converting: $SOURCE_FILE" -execute "open -R "(string escape $OUTPUT_FILE)"`"
